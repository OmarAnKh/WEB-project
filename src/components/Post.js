                                        ...
                                        <div className="card-footer bg-white " style={{ border: "0", margin: "0px", padding: "0px" }}>
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="d-flex align-items-center">
                                                    <button onClick={likeButton} type="button" className="btn" style={{ padding: "5px" }} >
                                                    ...
                                                    <button type="button" className="btn " onClick={commentButton} style={{ padding: "5px" }}>
                                                        ...
                                                        <div className="mb-0" style={{ fontSize: "17px", color: "gray", display: "inline" }}> {commentWord}<div key={data.id} style={{ display: "inline-block" }} >({
                                                            props.comments[id].comments?.length ? (props.comments[id]?.comments.length) : 0})</div>

                                                        </div>
                                                    </button>
                                                    <button type="button" className=" btn " style={{ pointerEvents: "none", padding: "5px" }}>
                                                ...
                                                <button type="button" className=" btn " onClick={shareButton} style={{ padding: "0px" }}>
